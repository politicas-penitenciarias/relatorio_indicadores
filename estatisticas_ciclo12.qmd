...
administradas pelo poder executivo em âmbitos federal e estadual, ou seja, cerca de **98%** dos estabelecimentos
...
A [seção @sec-populacao-prisional-ciclo12] trata do indicadores que definem a população prisional brasileira considerando os diversos tipos de estabelecimentos, regimes de custódia, gênero dos custodiados, modalidade de cumprimento de pena, além dos aspectos legais vinculados.
