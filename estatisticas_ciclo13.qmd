...
Foram coletadas informações de 
**`r format(sum(rel09_unid01$conta_unidades), big.mark = ".", decimal.mark = ",")`**
unidades prisionais das **1.551** existentes em territórios nacional 
administradas pelo poder executivo em âmbitos federal e estadual, ou seja, cerca **99%** dos estabelecimentos
responderam à pesquisa. Essas unidades são divididas em três tipos básicos considerando a forma 
de monitoramento da custódia, sendo: 
**`r format(rel09_unid01$conta_unidades[1], big.mark = ".", decimal.mark = ",")`**
unidades realizando a custódia tradicional de pessoas; 
**`r format(rel09_unid01$conta_unidades[2], big.mark = ".", decimal.mark = ",")`**
estabelecimentos possuindo infraestrutura para monitoramento eletrônico de pessoas em prisão 
domiciliar e; por fim,
**`r format(rel09_unid01$conta_unidades[3], big.mark = ".", decimal.mark = ",")`**
locais com responsabilidade de fiscalização de pessoas em prisão domiciliar sem 
auxílio de dispositivos eletrônicos de monitoramento. 


Outra fonte de dados traz informações acerca de pessoas presas em carceragens de delegacias e batalhões de polícia e bombeiro
militares. Essa pesquisa é realizada em formulário simplificado diretamente com os órgãos responsáveis 
pela administração dos supramencionados locais de encarceramento. Nesse caso, não houve resposta dos
orgãos no seguintes estados:

- **Departamento de Polícia Federal:** Amazonas, Distrito Federal, Espírito Santo, Maranhão, Minas Gerais,
Mato Grosso do Sul, Paraíba, Rondônia, Roraima, Rio Grande do Sul, Santa Catarina, Sergipe e Tocantins;

- **Departamento de Polícia Civil:** Alagoas, Amapá, Ceará, Maranhão, Piauí, Rio Grande do Norte, Rondônia,
Santa Catarina e Tocantins;

- **Polícia Militar:** Acre, Amapá, Ceará, Paraíba, Sergipe e Tocantins;

- **Corpo de Bombeiro Militar:** Acre, Amapá, Ceará, Maranhão, Rio Grande do Sul, Sergipe, 
...
A [seção @sec-populacao-prisional-ciclo13] trata do indicadores que definem a população prisional brasileira considerando os diversos tipos de estabelecimentos, regimes de custódia, gênero dos custodiados, modalidade de cumprimento de pena, além dos aspectos legais vinculados.
...
A [subseção @sec-indicadores-populacionais-brasil-ciclo13] trata do indicadores populacionais em âmbito nacional de forma tabular e gráfica em valores percentuais (relativos) e absolutos. Realiza-se o estudo da população prisional considerando as modalidades de custódia, e gêneros.
...
A primeira parte deste tópico ([subseção @sec-vagas-brasil-ciclo13]) trata da taxas supracitadas em âmbito nacional
calculadas sobre o somatório das populações prisionais estaduais. Dessa forma, retrata a realidade ampla do sistema 
penitenciário nacional. 

Em um segundo momento, trata-se das taxas de aprisionamento e penalização mais profundamente em âmbito estadual
[subseção @sec-vagas-uf-ciclo13]. O intuito é conhecer as realidades internas às unidades federativas e compará-las. 
...
**Taxa de aprisionamento:** Dada pela relação entre a **quantidade pessoas privadas de liberdade**[^estatisticas_ciclo13-1] cumprindo pena em estabelecimentos prisionais e a quantidade de habitantes no país, região ou estado para cada 100.000 habitantes.

[^estatisticas_ciclo13-1]: Quantitativo de pessoas cumprindo penas nas modalidades de custódia em estabelecimentos prisionais, carceragens e batalhões de polícia. Dessa maneira, exclui-se dessa variável as pessoas em prisão domiciliar.

$$
Taxa \ de \ aprisionamento  = \left(\dfrac{Número \ de \ pessoas \ privadas \ de \ liberdade}{Quantidade \ de \ habitantes}\right) \times 100.000
$$

**Taxa de penalização:** Dada pela relação entre a **população prisional geral** [^estatisticas_ciclo13-2] e a quantidade de habitantes no país, região ou estado para cada 100.000 habitantes.

[^estatisticas_ciclo13-2]: A **população prisional geral** é formada por pessoas cumprindo pena em todas as modalidades de custódia, sendo custodiados em: estabelecimentos prisionais, carceragens e batalhões de polícia, prisão domiciliar e prisão domiciliar com monitoramento eletrônico.
